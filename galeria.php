...
<li><a href="Galeria.php"><font size="5"><i class="icon-info-sign"></i>Galeria</font></a></li>
	...
	<div id="carousel">
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner">
				<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="imgs/galeria.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="imgs/otra1.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="imgs/otra2.jpg" class="carousel"></div>
			</div>
	...
	<div id="content">
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2>
			  <legend>Galeria</legend></h2></center>
			<br />
