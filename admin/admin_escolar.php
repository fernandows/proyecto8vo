...
<body>
			...
			<div class="modal-body">
				...
				<center>
					<table>
						...
						<tr>
							<td><input type="hidden" name="categoria" value="Escolar"></td>
						</tr>
					</table>
				</center>
			</div>
	...
	<?php
		if (isset($_POST['add']))
			...
			header ("location:admin_escolar.php");
		}}
	}
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			<div class="alert alert-info"><center><h2>Zapatos Antifluidos</h2></center></div>
			<br />
 ...
 $row = $result->fetch();
  ...
  echo "<script>window.location = 'admin_escolar.php'</script>";
