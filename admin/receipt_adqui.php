...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Facturas de Adquisiciones	</h2></center></div>
			<br />
	...
	<label style="font-size:20px;">Factura adquisicion</label>
		<tr>
		...
		<?php
		$t_id = $_GET['tid'];
		$query = $connect->query("SELECT * FROM adquisicion WHERE idadquisicion = '$t_id'") or die (mysqli_error());
		$fetch = $query->fetch();
		...
		$query2 = $connect->query("SELECT * FROM detalle_adqui  da INNEr join  producto p ON p.idproducto = da.idproducto WHERE da.idadquisicion  = '$t_id'") or die (mysqli_error());
