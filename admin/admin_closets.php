...
<body>
			...
			<div class="modal-body">
				...
				<center>
					<table>
						...
						<tr>
							<td><input type="hidden" name="categoria" value="Closets"></td>
						</tr>
					</table>
				</center>
			</div>
	...
	<?php
		if (isset($_POST['add']))
			...
			header ("location:admin_closets.php");
		}}
	}
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			<div class="alert alert-info"><center><h2>Guantes Antifluidos</h2></center></div>
			<br />
 ...
 $row = $result->fetch();
  ...
  echo "<script>window.location = 'admin_closets.php'</script>";
