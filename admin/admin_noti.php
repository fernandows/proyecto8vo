...
<body>
	...
	<br>
		...
		<a href="#add" role="button" class="btn btn-info" data-toggle="modal" style="position:absolute;margin-left:270px; margin-top:180px; z-index:-1000;"><i class="icon-plus-sign icon-white"></i>Agregar Noticia</a>
		<div id="add" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				...
				<h3 id="myModalLabel">Agregar Noticias...</h3>
			</div>
				<div class="modal-body">
					...
					<center>
						...
						<option value="Nuevo">Nuevo Noticia</option>
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					...
					<td><a href="../function/elim_noticia.php? id=<?php echo $fetch['noticiaid']?>" class='btn btn-danger'><i></i>Borrar</a></td>
