...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Ciudades de donde más se realizan las compras'
        },
        yAxis: {
            allowDecimals: false,
            title: {
...
<br>
    ...
    <?php
		$mes=date("Y-m");
      $query = $conn->query("SELECT pro.idproducto,cli.ciudad ,pro.producto ,count( det.idventa) as Fac_Aparece , sum( det.cantidad) as No_Producto , sum(tra.total) as total
			FROM detalle_v det
