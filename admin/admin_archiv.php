...
<body>
			...
			<div class="modal-body">
				...
				<center>
					<table>
						...
						<tr>
							<td><input type="hidden" name="categoria" value="Archivadores"></td>
						</tr>
					</table>
				</center>
			</div>
	...
	<?php
		if (isset($_POST['add']))
			...
			header ("location:admin_archiv.php");
		}}
	}
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			<div class="alert alert-info"><center><h2>Mascarillas Normales</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $connect->query("SELECT * FROM `producto` WHERE categoria='Archivadores' ORDER BY idproducto DESC") or die(mysqli_error());
 ...
 $row = $result->fetch();
  ...
  echo "<script>window.location = 'admin_archiv.php'</script>";
