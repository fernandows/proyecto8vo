...
<body>
					...
					<center>
						<table>
						   ...
						   <tr>
							...
							<tr>
								<td><input type="hidden" name="categoria" value="mas_vendidos"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			<div class="alert alert-info"><center><h2> Más Vendidos</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $connect->query("SELECT * FROM `producto` WHERE categoria='mas_vendidos' ORDER BY idproducto DESC") or die(mysqli_error());
