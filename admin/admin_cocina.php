...
<body>
			...
			<div class="modal-body">
				...
				<center>
					<table>
						...
						<tr>
							<td><input type="hidden" name="categoria" value="Cocina"></td>
						</tr>
					</table>
				</center>
			</div>
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $connect->query("SELECT * FROM `producto` WHERE categoria='Cocina' ORDER BY idproducto DESC") or die(mysqli_error());
 ...
 $row = $result->fetch();
  ...
  echo "<script>window.location = 'admin_cocina.php'</script>";
