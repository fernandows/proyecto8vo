...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Compras </h2></center></div>
			<br />
				<div style='width:975px;' class="alert alert-info">
					  <table class="table table-hover">
						<thead>
						  ...
						  <tbody>
							<?php
							$Q1 = $connect->query("SELECT * FROM transaction WHERE order_stat = 'Confirmed'");
							while($r1 = $Q1->fetch()){

							$tid = $r1['transaction_id'];

							$Q2 = $connect->query("SELECT * FROM transaction_detail LEFT JOIN product ON product.product_id = transaction_detail.product_id WHERE transaction_detail.transaction_id = '$tid' ");
							$r2 = $Q2->fetch();
							...
							$Q3 = $connect->query("SELECT sum(amount) FROM transaction WHERE order_stat = 'Confirmed'");
							while($r3 = $Q3->fetch()){
