...
<body>
			...
			<div class="modal-body">
				...
				<center>
					<table>
						...
						<tr>
							<td><input type="hidden" name="categoria" value="Recepciones"></td>
						</tr>
					</table>
				</center>
			</div>
	...
	<?php
		if (isset($_POST['add']))
			...
			header ("location:admin_recepcion.php");
		}}
	}
	...
	<div id="rightcontent" style="position:absolute; top:14%;">
			<div class="alert alert-info"><center><h2>Recepciones</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = $connect->query("SELECT * FROM `producto` WHERE categoria='Recepciones' ORDER BY idproducto DESC") or die(mysqli_error());
 ...
 $row = $result->fetch();
  ...
  echo "<script>window.location = 'admin_recepcion.php'</script>";
