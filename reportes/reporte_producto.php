...
$estado='MENOS VENDIDOS';
 $pdf->Cell(190,10,"REPORTE DE PRODUCTOS TOP- $estado",1,1,"C");}
else if($estado=="desc"){
$estado='MAS VENDIDOS';
$pdf->Cell(190,10,"REPORTE DE PRODUCTOS TOP- $estado",1,1,"C");
}
...
$pdf->Cell(0,2,"",0,1,"C");
    ...
    $pdf->Cell(30,8,"CODIGO",1,0,"C");
      $pdf->Cell(110,8,"PRODUCTO",1,0,"C");
        ...
        $pdf->Cell(25,8,"VENDIDOS",1,1,"C");
         $pdf->SetFont('Helvetica','',12);



 $estado=$_GET['producto'];
$vaciar=$conexion->query("SELECT det.idproducto , pro.producto,pro.precio,sum(det.cantidad) as Cantidad FROM
detalle_v det
