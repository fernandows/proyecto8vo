...
class Correo {
  const CORREO_EMISOR = "residentsadic19996@gmail.com";
  const CONTRASENIA_DEL_CORREO_EMISOR = "kevinboss4k";
  const EMPRESA = "FYASDAS";

  function enviarCorreoActivacion($correoDelDestinario, $propietarioDelCorreoDestinatario) {
    ...
    try {
      ...
      $mail->SMTPAuth = true;
      $mail->Username = self::CORREO_EMISOR;
      $mail->Password = self::CONTRASENIA_DEL_CORREO_EMISOR;
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
      $mail->Port = 587;
      $mail->setFrom(self::CORREO_EMISOR, self::EMPRESA);
      $mail->addAddress($correoDelDestinatario, $propietarioDelCorreoDestinatario);
      $mail->isHTML(true);
      $mail->Subject = 'Último paso ' . $propietarioDelCorreoDestinatario . ' activa tu cuenta';
      $mail->Body = '
      ...
      <body paddingwidth="0" paddingheight="0"
        style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0"
                                        ...
                                        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                              ...
                                              <a style="text-align: right" href=""><img src="" alt="logo" border="0" style="text-align: center;"></a>
                                              <tr>
                                                <td>
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td valign="top" class="specbundle">
                                                          <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable">
                                                              <p style="text-align:left;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;"><span class="font">Prodal</span> </p>
                                                            </div>
                                                          </div>
                                                        </td>
                                                      </tr>
                                            ...
                                            <tr>
                                              <td valign="top" align="center">
                                                <div class="contentEditableContainer contentImageEditable">
                                                  <div class="contentEditable">
                                                    <img src="https://i.ibb.co/Svp8gnb/line.png" width="251" height="43" alt="" data-default="placeholder" data-max-width="560">
                                                  </div>
                                                </div>
                                              </td>
                                            </tr>
                                              ...
                                              <td align="left">
                                                <div class="contentEditableContainer contentTextEditable">
                                                  <div class="contentEditable" align="center">
                                                    <h2>¡Felicitaciones por registrarse en Prodal!</h2>
                                                  </div>
                                                </div>
                                              </td>
                                            </tr>
                                                ...
                                                <div class="contentEditableContainer contentTextEditable">
                                                  <div class="contentEditable" align="center">
                                                    <p style="text-align: justify;">
                                                      ¡Gracias nuevamente por suscribirse al Prodal! Ya está todo configurado y recibirá los correos electrónicos una vez por semana. Mientras tanto, puede consultar nuestra
                                                      sección de Inicio para aprovechar al máximo su nueva cuenta.
                                                      <br>
                                                      <br>
                                                      ¿Tiene preguntas? Póngase en contacto con nosotros a través de Facebook o Twitter, o envíe un correo electrónico a nuestro equipo de soporte.
                                                      <br>
                                                      <br>
                                                      Saludos,
                                                      <br>
                                                      <span style="color:#222222;">' . $propietarioDelCorreoDestinatario . '</span>
                                                    </p>
                                                  </div>
                                                </div>
                                              </td>
                                                ...
                                                <table>
                                                  <tr>
                                                    <td align="center" bgcolor="#1A54BA" style="background:#1A54BA; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;">
                                                      <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable" align="center">
                                                          <a target="_blank" href="http://localhost/Prodal/controller/user_activation.php?user=' . $correoDelDestinario . '" class="link2" style="color:#ffffff;">Activa tu cuenta</a>
                                                        </div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                          ...
                                                          <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable" align="center">
                                                              <p style="text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;">
                                                                <span style="font-weight:bold;">Prodal</span>
                                                                <br>
                                                                www.prodal.com
                                                                <br>
                                                                <a target="_blank" href="[FORWARD]">Reenviar a un amigo</a><br>
                                                                <a target="_blank" class="link1" class="color:#382F2E;" href="[UNSUBSCRIBE]">Darse de baja</a>
                                                                <br>
                                                                <a target="_blank" class="link1" class="color:#382F2E;" href="[SHOWEMAIL]">Mostrar este correo electrónico en su navegador</a>
                                                              </p>
                                                            </div>
                                                          </div>
                                                        </td>
                                                              ...
                                                              <tr>
                                                                <td valign="top" width="52">
                                                                  <div class="contentEditableContainer contentFacebookEditable">
                                                                    <div class="contentEditable">
                                                                      <a target="_blank" href="#"><img src="https://i.ibb.co/6wYHRkm/facebook.png" width="52" height="53" alt="facebook icon" data-default="placeholder" data-max-width="52"
                                                                ...
                                                                <td valign="top" width="52">
                                                                  <div class="contentEditableContainer contentTwitterEditable">
                                                                    <div class="contentEditable">
                                                                      <a target="_blank" href="#"><img src="https://i.ibb.co/LSTrVL0/twitter.png" width="52" height="53" alt="twitter icon" data-default="placeholder" data-max-width="52"
                                                                          data-customIcon="true"></a>
                                                                    </div>
                                                                  </div>
                                                                </td>
  ...
  function enviarCorreoContactanos($nombre, $mensaje) {
    $mail = new PHPMailer(true);
    try {
      # $mail->SMTPDebug = SMTP::DEBUG_SERVER;
      $mail->isSMTP();
      ...
      $mail->Port = 587;
      $mail->setFrom(self::CORREO_EMISOR, self::EMPRESA);
      $mail->addAddress(self::CORREO_EMISOR, self::EMPRESA);
      $mail->isHTML(true);
                                        ...
                                        <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                              ...
                                              <a style="text-align: right" href=""><img src="" alt="" border="0" style="text-align: center;"></a>
                                              <tr>
                                                <td>
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        <td valign="top" class="specbundle">
                                                          <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable">
                                                              <p style="text-align:left;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;"><span class="font">PYE</span> </p>
                                                            </div>
                                                          </div>
                                                        </td>
                                                      </tr>
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                            ...
                                            <tr>
                                              <td align="left">
                                                <div class="contentEditableContainer contentTextEditable">
                                                  <div class="contentEditable" align="center">
                                                    <h2>¡Hemos recibido un correo contactanos!</h2>
                                                    <h2>Los datos son los siguientes:</h2>
                                                    <p style="color:#222222;">Nombre: ' . $nombre .'</p>
                                                    <br>
                                                    <p style="color:#222222;">Mensaje: ' . $mensaje . '</p>
                                                  </div>
                                                </div>
                                              </td>
                                            </tr>
