...
<div id="container">
	...
	<a href="https://play.google.com/store/apps/details?id=com.ar.augment&hl=es" target=”_blank”    > <img src=QRS/Logo.jpg  alt=Descargar ALIGN=RIGHT  WIDTH=190 HEIGHT=190″ /> </a>
...
<a href=" https://play.google.com/store/apps/details?id=com.ar.augment&hl=es" target=”_blank”    > <img src=QRS/metav.png  alt=Descargar ALIGN=RIGHT  WIDTH=90 HEIGHT=90″ /> </a>
		...
		<div class="nav1">
			<ul>
				...
				<li>|</li>
				<li><a href="product1.php" class="active" style="color:#111;" >Sillas</a></li>
...
<div id="product">
	...
	<?php
		...
		$query = $connect->query("SELECT * FROM producto WHERE categoria='sillas' ORDER BY idproducto DESC") or die (mysqli_error());
